              ...
              <form id="frm-addstore">
                  <div class="row">
                    ...
                    <div class="col-md-6 form-group mb-3">
                        ...
                        <textarea id="txt_description" name="data[description]" rows="3"  placeholder="<?php echo esc_attr__('Enter Description','asl_locator') ?>" maxlength="500" class="input-medium form-control"></textarea>
                    </div>

                    <div class="col-md-6 form-group mb-3">
                        <label for="txt_description_2"><?php echo esc_attr__('Additional Description','asl_locator') ?></label>
                        <textarea id="txt_description_2" name="data[description_2]" rows="3"  placeholder="<?php echo esc_attr__('Additional Description','asl_locator') ?>" maxlength="500" class="input-medium form-control"></textarea>
                    </div>
