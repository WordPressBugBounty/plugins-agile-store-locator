          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="asl-lock-inner">
                ...
                <a target="_blank" href="<?php echo esc_url( ASL_UPGRADE_URL ); ?>"><?php echo esc_attr__('License - $59','asl_locator') ?></a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="col-12">
          <div class="asl-benefits-ctn-box">
            <div class="position-relative" style="z-index: 1;">
              ...
              <ul>
                <li><?php echo esc_attr__('Use 6 Beautiful Store Locator Themes','asl_locator') ?></li>
              ...
              <a target="_blank" href="<?php echo esc_url( ASL_UPGRADE_URL ); ?>"><?php echo esc_attr__('Get License - $59','asl_locator') ?></a>
            </div>
      ...
      <div class="row">
        <div class="col-md-4">
          <ul class="asl-info-list">
            ...
            <li>
              <span><?php echo esc_attr__('Google API Key','asl_locator'); ?><i title="<?php echo esc_attr__('Green sign mean the Google API key is added in the plugin, doesn\'t mean you have configured it properly in Google Cloud Console.','asl_locator'); ?>" class="ms-2"><?php echo $quest_svg; ?></i></span>
